                                    ...
                                    <tbody>
                                        @foreach($data as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('jenis-service.edit', $row->id_jenis_service) }}" class="btn btn-warning">Edit</a>  
                                                    <span class="separator"></span>
                                                    <a href="{{ route('jenis-service.delete', $row->id_jenis_service) }}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
