                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="nama_pemilik"
                                                    value="{{ $row->nama_pemilik }}" required
                                                />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                />
                                                <div class="invalid-feedback">Masukkan Tanggal lahir terlebih dahulu!!!</div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            />
                                            <div class="invalid-feedback">Masukkan No Handphone terx    xlebih dahulu!!!</div>
                                        </div>
                                            </div>
                                        </div>
                                    </div>
